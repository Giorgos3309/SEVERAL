...
public class BHTree {
  ...
  public void insert(Body b) {
    ...
    if (this.body==null) {
    	b.setMinQuadLength(this.quad.length());
        this.body=b;
    }
  ...
  public void updateForce(Body b) {
    ...
    else if ( b.in(this.quad)==false && (this.body.distanceTo(b)>b.getMinQuadLength()) ){
  ...
  public void PreOrder(BHTree tr) {
	  if(tr==null) {
		  return;
	  }
	  System.out.println(tr.body);
	  PreOrder(tr.NE);
	  PreOrder(tr.NW);
	  PreOrder(tr.SE);
	  PreOrder(tr.SW);
